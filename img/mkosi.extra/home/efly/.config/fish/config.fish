...
if status is-login
    if test -z "$DISPLAY" -a "$XDG_VTNR" = 1
        ...
        echo
        echo FIXME for an unknown reason X server will fail with "no screens found",
        echo if we start it immediately at boot. creating an artificial delay before starting X11.
        echo "3..."; sleep 1
        echo "2..."; sleep 1
        echo "1..."; sleep 1
